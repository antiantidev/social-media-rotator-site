...
export interface LandingHowItWorksSectionProps extends Readonly<Record<string, never>> {}

export function LandingHowItWorksSection(_: LandingHowItWorksSectionProps) {
  return (
